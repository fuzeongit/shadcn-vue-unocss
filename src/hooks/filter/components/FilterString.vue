...
const { search, filterOptions, form } = useFilterInject<QuickFilter.StringOption, VM>()!;
    ...
    <Popover v-model:open="open">
      <PopoverTrigger as-child>
        <Button variant="link" class="!p-1">
          <IconIconoirFilterSolid v-if="field.value" class="text-primary"></IconIconoirFilterSolid>
